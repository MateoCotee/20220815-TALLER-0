...
public class CalculadoraEstadisticas
{
	...
	public String PaisRepresentadoPorAtleta (String nombreAtleta)
	{
		String retorno = "";
		Atleta atletaEscogido = buscarAtleta(nombreAtleta);
		System.out.println("El atleta representa el pais: " + atletaEscogido.darPais().darNombre());
		return retorno;
	}
