...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pais representado por un atleta");
...
/** Metodo que le pide al usuario el nombre de un atleta y 
 *  se le retorna el pais al que representa
 */
	private void ejecutarPaisRepresentadoPorAtleta()
	{
	String atleta = input("Por favor ingrese el nombre del atleta: ");
	String retorno = calculadora.PaisRepresentadoPorAtleta(atleta);
